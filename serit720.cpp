...
void laneCenterer()
{
    ...
    /*if (result < -350 || result > 350)
    {
        cerr << "Error: result out of range: " << result << endl;
        result = 0; // Varsayılan bir değer ata
    }*/

    mapped_result = mapper(result, -350, 350, minCmd, maxCmd);//micmd normalde 0 200 rasındydı
